package com.example.recordxx.util
...
object SpanUtil {
    ...
    class SpanBuilder {
         ...
         */
        var spanStrBuilder: SpannableStringBuilder?
            private set
        ...
        fun addForeColorSection(section: String?, color: Int): SpanBuilder {
            return addCertainSection(section, ForegroundColorSpan(color), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        }
        ...
        fun addBackColorSection(section: String?, color: Int): SpanBuilder {
            return addCertainSection(section, BackgroundColorSpan(color), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        }
        ...
        fun addAbsSizeSection(section: String?, size: Int): SpanBuilder {
            return addCertainSection(section, AbsoluteSizeSpan(size), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        }
        ...
        fun addRelSizeSection(section: String?, proportion: Float): SpanBuilder {
            return addCertainSection(section, RelativeSizeSpan(proportion), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        }
        ...
        fun addTypefaceSection(section: String?, family: String?): SpanBuilder {
            return addCertainSection(section, TypefaceSpan(family), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        }
        ...
        fun addMaskSection(section: String?, maskFilter: MaskFilter?): SpanBuilder {
            return addCertainSection(section, MaskFilterSpan(maskFilter), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        }

        private fun onDecor(section: String, ignoreCase: Boolean, which: Which, decorCallback: DecorCallback): SpanBuilder {
            var section = section
            var baseStr = string
            if (ignoreCase) {
         ...
         */
        fun setForeColor(section: String, color: Int, ignoreCase: Boolean, which: Which): SpanBuilder {
        ...
        fun setForeColor(color: Int, start: Int, end: Int): SpanBuilder {
            spanStrBuilder!!.setSpan(ForegroundColorSpan(color), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
            return this
        }
         ...
         * 加上背景色
         */
        fun setBackColor(section: String, color: Int, ignoreCase: Boolean, which: Which): SpanBuilder {
            return onDecor(section, ignoreCase, which, object : DecorCallback {
                override fun decor(start: Int, end: Int) {
        ...
        fun setBackColor(color: Int, start: Int, end: Int): SpanBuilder {
            spanStrBuilder!!.setSpan(BackgroundColorSpan(color), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
            return this
        }
        ...
        fun setAsSuperscript(start: Int, end: Int): SpanBuilder {
            spanStrBuilder!!.setSpan(SuperscriptSpan(), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
            return this
        }
        ...
        fun setStrikethrough(start: Int, end: Int): SpanBuilder {
            spanStrBuilder!!.setSpan(StrikethroughSpan(), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
            return this
        }
        ...
        fun setAbsSize(size: Int, start: Int, end: Int): SpanBuilder {
            spanStrBuilder!!.setSpan(AbsoluteSizeSpan(size), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
            return this
        }
        ...
        fun setRelSize(proportion: Float, start: Int, end: Int): SpanBuilder {
            spanStrBuilder!!.setSpan(RelativeSizeSpan(proportion), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
            return this
        }
        ...
        fun setTypeface(family: String?, start: Int, end: Int): SpanBuilder {
            spanStrBuilder!!.setSpan(TypefaceSpan(family), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
            return this
        }
        ...
        fun setMask(maskFilter: MaskFilter?, start: Int, end: Int): SpanBuilder {
            spanStrBuilder!!.setSpan(MaskFilterSpan(maskFilter), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
            return this
        }
         ...
         * @param end       截止位置
         */
        fun setAlign(alignment: Alignment?, start: Int, end: Int): SpanBuilder {
            spanStrBuilder!!.setSpan(Standard(alignment), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
            return this
        }
        ...
        fun insertImage(context: Context?, resId: Int, where: Int): SpanBuilder {
            ...
            spanStrBuilder!!.setSpan(ImageSpan(context, resId), where, where + 1, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
            return this
        }
